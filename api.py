...
#####################################################
    ...
    def add_new_pet_wo_photo(self, auth_key: json, name: str, animal_type: str, age: str) -> json:
    ...
    def add_pets_photo(self, auth_key: json, pet_id: str, pet_photo: str) -> json:
        """Метод отправляет (постит) на сервер данные о фотографии питомца и возвращает статус
        запроса на сервер и результат в формате JSON с данными, добавленными питомцу"""
